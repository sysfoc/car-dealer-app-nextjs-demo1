    ...
    <div className="sticky top-3">
      ...
      <Table hoverable className="mt-3 dark:bg-gray-700">
        <TableBody className="divide-y">
          ...
          <TableRow>
            <TableCell className="font-semibold text-blue-950 dark:text-gray-200">Doors</TableCell>
            <TableCell>2</TableCell>
          </TableRow>
          <TableRow>
            <TableCell className="font-semibold text-blue-950 dark:text-gray-200">Seats</TableCell>
          ...
          <TableRow>
            <TableCell className="font-semibold text-blue-950 dark:text-gray-200">Gears</TableCell>
