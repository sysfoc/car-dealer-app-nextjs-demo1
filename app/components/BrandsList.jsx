...
const BrandsList = () => {
  ...
  return (
    <section className="bg-[#F9FBFC] px-4 py-10 dark:bg-gray-800 sm:px-12 md:py-20">
      ...
      <div className="mt-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
        {brandLists.map((brand, index) => (
          <div className="rounded-xl border border-gray-100 bg-white p-5 transition-all delay-75 hover:border-blue-600 dark:bg-gray-800" key={index}>
            <Link href={`${brand.url}`}>
              <div>
                <div>
                  <Image
