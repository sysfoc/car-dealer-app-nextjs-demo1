...
const Footerr = ({ isDarkMode }) => {
  ...
  return (
    <div className="relative mt-16">
      ...
      <Footer className="relative pt-16 md:pt-20 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-800 dark:via-gray-900 dark:to-gray-950">
