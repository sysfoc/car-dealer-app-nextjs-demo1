      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative px-4 py-12 sm:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="backdrop-blur-md bg-red-50/70 dark:bg-red-900/20 border border-red-200/50 dark:border-red-500/20 rounded-3xl p-6">
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-12 fill-gray-900 dark:fill-white transform rotate-180">
